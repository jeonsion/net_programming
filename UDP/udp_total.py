...
if __name__ == '__main__':
    ...
    parser.add_argument('role', choices=mode, help="hich role to take beween server and client")
    ...
    parser.add_argument('-prob', type = float, default=0, help="drop probability (default 0~1")
